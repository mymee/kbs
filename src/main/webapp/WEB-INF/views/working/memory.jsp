    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#workingMemorySave').click(function () {
                ...
                var result = confirm($("#teamCode").val() + '조\n문제풀이를 종료하시겠습니까?');
                if (!result) {
                    return false;
                }
...
<table id="workingMemory" width="1920" height="1080" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
        <td>
            ...
            <!-- 메모리퀴즈 좌표입력 부분 -->
            <div class='mem_inpt1'>
                <input id="xy1" name="xy1" type="text" value="1,4" style="width: 120px; height: 80px; text-align:center; font-size: 64px; opacity:0.5;">
            </div>
            <div class='mem_inpt2'>
                <input id="xy2" name="xy2" type="text" value="2,4" style="width: 120px; height: 80px; text-align:center; font-size: 64px; opacity:0.5;">
            </div>
            <div class='mem_inpt3'>
                <input id="xy3" name="xy3" type="text" value="3,4" style="width: 120px; height: 80px; text-align:center; font-size: 64px; opacity:0.5;">
            </div>
            <div class='mem_inpt4'>
                <input id="xy4" name="xy4" type="text" value="4,4" style="width: 120px; height: 80px; text-align:center; font-size: 64px; opacity:0.5;">
            </div>
            <div class='mem_inpt5'>
                <input id="xy5" name="xy5" type="text" value="5,4" style="width: 120px; height: 80px; text-align:center; font-size: 64px; opacity:0.5;">
            </div>
            <div class='mem_inpt6'>
                <input id="xy6" name="xy6" type="text" value="1,3" style="width: 120px; height: 80px; text-align:center; font-size: 64px; opacity:0.5;">
            </div>
            <div class='mem_inpt7'>
                <input id="xy7" name="xy7" type="text" value="2,3" style="width: 120px; height: 80px; text-align:center; font-size: 64px; opacity:0.5;">
            </div>
            <div class='mem_inpt8'>
                <input id="xy8" name="xy8" type="text" value="3,3" style="width: 120px; height: 80px; text-align:center; font-size: 64px; opacity:0.5;">
            </div>
            <div class='mem_inpt9'>
                <input id="xy9" name="xy9" type="text" value="4,3" style="width: 120px; height: 80px; text-align:center; font-size: 64px; opacity:0.5;">
            </div>
            <div class='mem_inpt10'>
                <input id="xy10" name="xy10" type="text" value="5,3" style="width: 120px; height: 80px; text-align:center; font-size: 64px; opacity:0.5;">
            </div>
            <div class='mem_inpt11'>
                <input id="xy11" name="xy11" type="text" value="1,2" style="width: 120px; height: 80px; text-align:center; font-size: 64px; opacity:0.5;">
            </div>
            <div class='mem_inpt12'>
                <input id="xy12" name="xy12" type="text" value="2,2" style="width: 120px; height: 80px; text-align:center; font-size: 64px; opacity:0.5;">
            </div>
            <div class='mem_inpt13'>
                <input id="xy13" name="xy13" type="text" value="3,2" style="width: 120px; height: 80px; text-align:center; font-size: 64px; opacity:0.5;">
            </div>
            <div class='mem_inpt14'>
                <input id="xy14" name="xy14" type="text" value="4,2" style="width: 120px; height: 80px; text-align:center; font-size: 64px; opacity:0.5;">
            </div>
            <div class='mem_inpt15'>
                <input id="xy15" name="xy15" type="text" value="5,2" style="width: 120px; height: 80px; text-align:center; font-size: 64px; opacity:0.5;">
            </div>
            <div class='mem_inpt16'>
                <input id="xy16" name="xy16" type="text" value="1,1" style="width: 120px; height: 80px; text-align:center; font-size: 64px; opacity:0.5;">
            </div>
            <div class='mem_inpt17'>
                <input id="xy17" name="xy17" type="text" value="2,1" style="width: 120px; height: 80px; text-align:center; font-size: 64px; opacity:0.5;">
            </div>
            <div class='mem_inpt18'>
                <input id="xy18" name="xy18" type="text" value="3,1" style="width: 120px; height: 80px; text-align:center; font-size: 64px; opacity:0.5;">
            </div>
            <div class='mem_inpt19'>
                <input id="xy19" name="xy19" type="text" value="4,1" style="width: 120px; height: 80px; text-align:center; font-size: 64px; opacity:0.5;">
            </div>
            <div class='mem_inpt20'>
                <input id="xy20" name="xy20" type="text" value="5,1" style="width: 120px; height: 80px; text-align:center; font-size: 64px; opacity:0.5;">
            </div>
            <!-- 메모리퀴즈 좌표입력 부분 -->
