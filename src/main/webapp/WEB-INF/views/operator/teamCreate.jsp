        ...
        <div class="right_col" role="main">
            <div class="">
                ...
                <div class="row">
                    ...
                    <div class="x_content">
                        <form id="teamInfoForm" name="teamInfoForm" method="POST" action="${pageContext.request.contextPath}/operator/team/insert">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:left;padding-left:10px;width:90%;">
                                        <input class="form-control" style="display:inline-block;;" type="text"
                                               id="schoolName" name="schoolName" maxlength="20" value=""/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="active text-center"
                                    ...
                                    <td style="text-align:left;padding-left:10px;width:90%;">
                                        <input class="form-control" style="display:inline-block;;" type="text"
                                               id="teamName" name="teamName" maxlength="20" value=""/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="active text-center"
                                    ...
                                    <td style="text-align:left;padding-left:10px;">
                                        <input class="form-control" style="display:inline-block;" type="text"
                                               id="teamBaseScore" name="teamBaseScore" maxlength="20" value="0"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="active text-center"
                                    ...
                                    <td style="text-align:left;padding-left:10px;">
                                        <input type="checkbox" id="chance1" name="chance1" value="1" class="minimal" style="width:18px;height:18px;">
                                    </td>
                                </tr>
                                <tr>
                                    <td class="active text-center"
                                    ...
                                    <td style="text-align:left;padding-left:10px;">
                                        <input type="checkbox" id="chance2" name="chance2" value="1" class="minimal" style="width:18px;height:18px;">
                                    </td>
                                </tr>
                                <tr>
                                    <td class="active text-center"
                                    ...
                                    <td style="text-align:left;padding-left:10px;">
                                        <input type="checkbox" id="chance3" name="chance3" value="1" class="minimal" style="width:18px;height:18px;">
                                    </td>
                                </tr>
                                <tr>
                                    <td class="active text-center"
                                    ...
                                    <td style="text-align:left;padding-left:10px;">
                                        <input type="checkbox" id="chance4" name="chance4" value="1" class="minimal" style="width:18px;height:18px;">
                                    </td>
                                </tr>
                                <!--
                                <tr>
                        ...
                        <div class="table-bottom">
                            <div class="grid-btn-group">
                                <div class="btn-group pull-right" role="group" aria-label="..."
                                    ...
                                    <button type="button" id="teamInfoCreate" name="teamInfoCreate"
                                            class="btn btn-info"> 등록
                                    </button>
